...
describe('Warehouse Service AllocateOrderStockApi OrderStockDepletedEvent tests', () => {
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput is undefined', () => {
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput is null', () => {
  ...
  //
  it('non transient Failure if the input OrderStockDepletedEventInput.orderId is missing', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.orderId is undefined', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.orderId is null', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.orderId is empty', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.orderId is blank', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
    mockOrderStockDepletedEventInput.orderId = '      '
    const result = OrderStockDepletedEvent.validateAndBuild(mockOrderStockDepletedEventInput)
    expect(Result.isFailure(result)).toBe(true)
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.orderId length < 4', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  //
  it('non transient Failure if the input OrderStockDepletedEventInput.sku is missing', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.sku is undefined', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.sku is null', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.sku is empty', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.sku is blank', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
    mockOrderStockDepletedEventInput.sku = '      '
    const result = OrderStockDepletedEvent.validateAndBuild(mockOrderStockDepletedEventInput)
    expect(Result.isFailure(result)).toBe(true)
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.sku length < 4', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  //
  it('non transient Failure if the input OrderStockDepletedEventInput.units is missing', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.units is undefined', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.units is null', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.units < 0', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.units is not an integer', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  it('non transient Failure if the input OrderStockDepletedEventInput.units is not a number', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
  ...
  //
  it('returns the expected Success<OrderStockDepletedEvent> with eventName and eventData', () => {
    const mockOrderStockDepletedEventInput = buildMockValidOrderStockDepletedEventInput()
