...
describe('Warehouse Service AllocateOrderStockApi OrderStockAllocatedEvent tests', () => {
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput is undefined', () => {
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput is null', () => {
  ...
  //
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.orderId is missing', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.orderId is undefined', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.orderId is null', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.orderId is empty', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.orderId is blank', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
    mockOrderStockAllocatedEventInput.orderId = '      '
    const result = OrderStockAllocatedEvent.validateAndBuild(mockOrderStockAllocatedEventInput)
    expect(Result.isFailure(result)).toBe(true)
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.orderId length < 4', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  //
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.sku is missing', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.sku is undefined', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.sku is null', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.sku is empty', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.sku is blank', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
    mockOrderStockAllocatedEventInput.sku = '      '
    const result = OrderStockAllocatedEvent.validateAndBuild(mockOrderStockAllocatedEventInput)
    expect(Result.isFailure(result)).toBe(true)
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.sku length < 4', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  //
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.units is missing', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.units is undefined', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.units is null', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.units < 0', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.units is not an integer', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  it('returns a non transient Failure if the input OrderStockAllocatedEventInput.units is not a number', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
  ...
  //
  it('returns the expected Success<OrderStockAllocatedEvent> with eventName and eventData', () => {
    const mockOrderStockAllocatedEventInput = buildMockValidOrderStockAllocatedEventInput()
