...
describe(`Warehouse Service ValueValidators tests`, () => {
  describe(`validSkuRestockedEventName tests`, () => {
    ...
    it(`is valid if the input eventName is a WarehouseEventName.SKU_RESTOCKED_EVENT`, () => {
      const testInput = WarehouseEventName.SKU_RESTOCKED_EVENT
  ...
  describe(`validOrderCreatedEventName tests`, () => {
    ...
    it(`is valid if the input eventName is a WarehouseEventName.ORDER_CREATED_EVENT`, () => {
      const testInput = WarehouseEventName.ORDER_CREATED_EVENT
      expect(() => ValueValidators.validOrderCreatedEventName().parse(testInput)).not.toThrow()
    })
  })

  describe(`validOrderEventNameGroup tests`, () => {
    const testEventGroup: WarehouseEventName[] = [
      WarehouseEventName.ORDER_CANCELED_EVENT,
    ...
    it(`throws if the input the event group is empty`, () => {
      const testInput = WarehouseEventName.ORDER_CANCELED_EVENT
