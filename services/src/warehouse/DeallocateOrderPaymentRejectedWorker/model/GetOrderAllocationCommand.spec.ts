...
describe(`Warehouse Service DeallocateOrderPaymentRejectedWorker GetOrderAllocationCommand tests`, () => {
  ...
  //
  it(`returns a Success if the input GetOrderAllocationCommandInput is valid`, () => {
  ...
  //
  it(`returns a non-transient Failure of kind InvalidArgumentsError if the input
      GetOrderAllocationCommandInput.orderId is missing`, () => {
    const mockGetOrderAllocationCommandInput = buildMockGetOrderAllocationCommandInput()
    delete mockGetOrderAllocationCommandInput.orderId
    const result = GetOrderAllocationCommand.validateAndBuild(mockGetOrderAllocationCommandInput)
    expect(Result.isFailure(result)).toBe(true)
    expect(Result.isFailureOfKind(result, 'InvalidArgumentsError')).toBe(true)
    expect(Result.isFailureTransient(result)).toBe(false)
  ...
  //
  it(`returns a non-transient Failure of kind InvalidArgumentsError if the input
    GetOrderAllocationCommandInput.sku is missing`, () => {
    const mockGetOrderAllocationCommandInput = buildMockGetOrderAllocationCommandInput()
    delete mockGetOrderAllocationCommandInput.sku
    const result = GetOrderAllocationCommand.validateAndBuild(mockGetOrderAllocationCommandInput)
    expect(Result.isFailure(result)).toBe(true)
    expect(Result.isFailureOfKind(result, 'InvalidArgumentsError')).toBe(true)
    expect(Result.isFailureTransient(result)).toBe(false)
  ...
  //
  it(`returns the expected Success<GetOrderAllocationCommand> with the expected data`, () => {
    const mockGetOrderAllocationCommandInput = buildMockGetOrderAllocationCommandInput()
    const result = GetOrderAllocationCommand.validateAndBuild(mockGetOrderAllocationCommandInput)
