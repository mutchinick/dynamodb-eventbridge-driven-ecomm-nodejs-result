...
describe(`Testing Service SimulateRawEventApi IncomingSimulateRawEventRequest tests`, () => {
   ...
   ************************************************************/
  it(`does not return a Failure if the input IncomingSimulateRawEventRequestInput is
      valid`, async () => {
  ...
  it(`does not return a Failure if the input
      IncomingSimulateRawEventRequestInput.createdAt is undefined`, async () => {
    const mockIncomingSimulateRawEventRequestInput = buildMockIncomingSimulateRawEventRequestInput()
  ...
  it(`does not return a Failure if the input
      IncomingSimulateRawEventRequestInput.createdAt is empty`, async () => {
    const mockIncomingSimulateRawEventRequestInput = buildMockIncomingSimulateRawEventRequestInput()
  ...
  it(`does not return a Failure if the input
      IncomingSimulateRawEventRequestInput.createdAt is blank`, async () => {
    const mockIncomingSimulateRawEventRequestInput = buildMockIncomingSimulateRawEventRequestInput()
    mockIncomingSimulateRawEventRequestInput.createdAt = '      ' as never
    const result = IncomingSimulateRawEventRequest.validateAndBuild(mockIncomingSimulateRawEventRequestInput)
    expect(Result.isFailure(result)).toBe(false)
  ...
  it(`returns a non-transient Failure of kind InvalidArgumentsError if the input
      IncomingSimulateRawEventRequestInput.createdAt is not a string`, async () => {
    const mockIncomingSimulateRawEventRequestInput = buildMockIncomingSimulateRawEventRequestInput()
   ...
   ************************************************************/
  it(`does not return a Failure if the input
      IncomingSimulateRawEventRequestInput.updatedAt is undefined`, async () => {
    const mockIncomingSimulateRawEventRequestInput = buildMockIncomingSimulateRawEventRequestInput()
  ...
  it(`does not return a Failure if the input
      IncomingSimulateRawEventRequestInput.updatedAt is empty`, async () => {
    const mockIncomingSimulateRawEventRequestInput = buildMockIncomingSimulateRawEventRequestInput()
  ...
  it(`does not return a Failure if the input
      IncomingSimulateRawEventRequestInput.updatedAt is blank`, async () => {
    const mockIncomingSimulateRawEventRequestInput = buildMockIncomingSimulateRawEventRequestInput()
    mockIncomingSimulateRawEventRequestInput.updatedAt = '      ' as never
    const result = IncomingSimulateRawEventRequest.validateAndBuild(mockIncomingSimulateRawEventRequestInput)
    expect(Result.isFailure(result)).toBe(false)
  ...
  it(`returns a non-transient Failure of kind InvalidArgumentsError if the input
      IncomingSimulateRawEventRequestInput.updatedAt is not a string`, async () => {
    const mockIncomingSimulateRawEventRequestInput = buildMockIncomingSimulateRawEventRequestInput()
   ...
   ************************************************************/
  it(`returns the expected Success<IncomingSimulateRawEventRequest> if the execution
