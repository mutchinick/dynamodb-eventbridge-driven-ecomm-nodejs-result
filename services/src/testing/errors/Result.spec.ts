...
describe(`Testing Service Result tests`, () => {
  ...
  describe(`Result.makeFailure`, () => {
    ...
    it(`returns a transient Failure with the expected FailureKind and Error
    ...
    it(`returns a Failure with an Error with the expected error message when
